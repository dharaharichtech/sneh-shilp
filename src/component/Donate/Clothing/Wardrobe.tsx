  ...
  return (
    <section className="w-full mt-[-200px] md:mt-[-150px]">
      ...
      >
        ...
        <h2 className={`${calistoga.className} text-3xl md:text-5xl text-[#73BE5F] mt-3`}>
          {data.heading}
        </h2>
        ...
        <div className="grid sm:grid-cols-2 md:grid-cols-4 gap-6 mt-10">
          {data.boxes.map((box, i) => (
            <motion.div
              ...
              className={`rounded-2xl p-6 transition-all ${box.bg || "bg-white"}`}
            >
              ...
              <h4 className={`${calistoga.className} text-[#73BE5F] text-xl text-center mt-1`}>
                {box.title}
              </h4>
            </motion.div>
          ))}
      ...
      <div className="bg-[#EEFFE9] py-10 md:py-16 px-5 md:px-10">
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-10 items-center">
          ...
          >
            ...
            <h2 className={`${calistoga.className} text-2xl md:text-5xl text-[#73BE5F] mb-3`}>
            ...
            <motion.a
              ...
              whileHover={{ scale: 1.05 }}
              className="flex items-center justify-center gap-3 bg-[#73BE5F] text-white px-6 py-3 rounded-full hover:bg-[#5FA94E] transition-all mx-auto md:ml-0"
            >
              <Image
